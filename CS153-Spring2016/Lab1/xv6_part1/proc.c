...
exit(int status)
{
  ...
  //THE FOLLOWING PART HANDLES THE FUNCTIONS WHICH ARE WAITING ON A PROCESS
  // FROM WAITPID. THE FOLLOWING PART ENSURES THAT IF A PROCESS IS ENDING,
  //AND OTHER PROCESSES ARE WAITING FOR ITS COMPLETION THEY'RE WOKEN FROM 
  //SLEEP DUE TO WAITPID
